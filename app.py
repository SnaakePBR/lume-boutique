...
# ==========================================
# HTML + CSS + JS (CARRINHO INTEGRADO)
# ==========================================
...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .hero {
            height: 100vh;
            background: linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.4)), url('https://images.unsplash.com/photo-1529139574466-a303027c1d8b?w=1600&q=80');
        ...
        /* ================= GRID ================= */
        .grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 40px; margin-bottom: 60px; }

        /* ================= CARD ================= */
        .card { background: var(--branco); border: 1px solid var(--apoio); overflow: hidden; transition: 0.4s; display: flex; flex-direction: column; }
        ...
        @media(max-width:900px){
            ...
            .nav-center a { display: none; } /* Esconde links, mantém o carrinho */
        }
        @media(max-width:600px){
            .hero h1 { font-size: 3rem; letter-spacing: 4px; }
            .title h2 { font-size: 2.2rem; }
            .categoria-titulo { font-size: 2rem; }
...
<body>
    ...
    <section class="about-section" id="sobre">
        <div class="about">
            <img src="https://images.unsplash.com/photo-1483985988355-763728e1935b?w=1200&q=80">
    ...
    <script>
        ...
        // Busca o carrinho salvo no dispositivo ou inicia vazio
        ...
        function adicionarAoCarrinho(nome, preco, imagem) {
            ...
            salvarCarrinho();
            abrirCarrinho(); // Abre a gaveta automaticamente pra pessoa ver o que adicionou
        }
        ...
        function finalizarCompra() {
            if(carrinho.length === 0) {
                alert("Por favor, adicione peças ao carrinho antes de finalizar.");
                return;
            }
        ...
        // Ao carregar a página, atualiza o ícone e a lista
